  ...
  return (
    <div>
      ...
      <p>
        ...
        несколько <NavLink to='/cv/projects'>проектов</NavLink>, которые были
        ...
        <NavLink to='/cv/certificates'>сертификатов</NavLink>, чтобы быть более
      ...
      <p>
        17 лет опыта работы связаны с торговлей. Начиная с 18 лет, работал в
